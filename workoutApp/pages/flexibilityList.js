...
export default function FlexListScreen() {
    ...
    return (
        <SafeAreaView style={FLEXIBILITYSTYLE.listContainer}>
            <ScrollView>
            {flexibilityWorkouts.map((exercise) =>
                <SafeAreaView key={`${exercise.title} - mainKey`}>
                    ...
                    >
                        <Text style={FLEXIBILITYSTYLE.exercise}>{exercise.title}</Text>
                    </TouchableOpacity>
                    <Modal
                    ...
                    >
                        <SafeAreaView style={FLEXIBILITYSTYLE.descriptionModal}>
                            <ScrollView>
                                <Text style={FLEXIBILITYSTYLE.exercise}>{curDesc}</Text>
                            </ScrollView>
                        </SafeAreaView>
                    </Modal>
                </SafeAreaView>
